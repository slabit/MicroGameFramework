...
namespace ReplaceBy
{
	public static class ReplaceByUtility
	{
		                             ...
		                             bool scaleOverride = false)
		{
			...
			{
				GameObject createdGameObject = ReplaceBy(gameObjectToReplace, gameObjectModelReplacing, scaleOverride);
		...
		public static GameObject ReplaceBy(GameObject gameObjectToReplace, GameObject gameObjectModelReplacing, bool scaleOverride)
		{
