...
namespace gk
{
	...
	{	
		...
		public static float GetAxisValue(string axisName)
		{
			...
			foreach(gkInputMappingScheme inputMappingScheme in ms_oInstance.m_oCurrentInputMappingSchemes)
			{
				axisValue = Mathf.Max(axisValue, inputMappingScheme.GetAxisValue(axisName));
			}
